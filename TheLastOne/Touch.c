...
extern unsigned char keyA, keyB;
...
void Key(){
    if(Getpix()==1){
        if(ly>280 && ly<310){
            if(lx>5 && lx<70){
                keyA=1;
                GUIsquare2pix(5,280,70,310,Red);
                while(PEN==0);
                GUIsquare2pix(5,280,70,310,White);
            }else if(lx>170 && lx<230){
                keyB=1;
                GUIsquare2pix(170,280,235,310,Red);
                while(PEN==0);
                GUIsquare2pix(170,280,235,310,White);
            }
        }
    }
}
